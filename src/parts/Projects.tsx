...
const ProjectsArray = [
    {
        ...
        technology: ['Next.js', 'React', 'Redux toolkit', 'Typescript', 'Javascript', 'Styled-components', 'Jest', 'MongoDB', 'Express', 'JWT', 'Redis', 'Socket.io', 'PWA', 'IndexedDB', 'MUI', 'i18n', 'Cookies', 'etc.'],
